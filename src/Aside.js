...
import './Aside.css'
import AsideAdImg from './AsideAdImg'
    ...
    render() {
        ...
        <aside className="large-4 medium-12 columns">
            <div className="ad">
              ...
              <p className="ad-text">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. 
                  ...
                  Gratuitous octopus niacin, sodium glutimate. Quote meon an estimate et non interruptus stadium.</p>

              <p className="ad-text">Sic tempus fugit esperanto hiccup estrogen. 
